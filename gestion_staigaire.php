                           ...
                           <div class="dash_head">
                              <h3 data-toggle="modal" data-target="#exampleModal">
                                 <span><i class="fa fa-comments-o">
                                    ...
                                    </i> liste Des staigaires</span><span class="plus_green_bt">+
                                 </span>
                              </h3>

                           </div>
                           <div class="list_cont">
                              <p>gestion des staigaires</p>
                           </div>
                           <div class="msg_list_main">
                              <ul class="msg_list">
                              <li>
                              <?php
                                    $con = $con->prepare('SELECT * FROM stagiaire ');
                                    $con->execute();
               ...
               <div class="modal-dialog " role="document">
                  <div class="modal-content">
                     <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">ajouter un staigaire</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                           <span aria-hidden="true">&times;</span>
                        </button>
                     </div>
                     <form action="inset_staigaire.php" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                           ...
                           <div class="form-row">
                              ...
                              <div class="col-md-4 mb-3">
                                 ...
                                 <input type="text" name="pays" class="form-control" id="pays" placeholder="etat" required>
                              </div>
                              <div class="col-md-4 mb-3">
                        ...
                        <div class="modal-footer">
                           ...
                           <a href="gestion_staigaire.php"><button class="btn btn-primary" type="submit">Submit form</button></a>
                        </div>
                     </form>
                  </div>
               </div>
         ...
         <div class="row column1">
                     <div class="dash_blog">
                        <div class="dash_blog_inner">
                           <div class="dash_head">
                              <h3 data-toggle="modal" data-target="#exampleModal">
                                 <span>ATTESTATION DE SATGE</span>
                              </h3>
                           </div>
